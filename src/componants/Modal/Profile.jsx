    ...
    <div>
      ...
      >
        <div
          ...
          className={`absolute overflow-x-hidden overflow-y-scroll w-full h-full flex justify-center bg-white/20 backdrop-blur-md drop-shadow-2xl rounded-lg ${
            openModal
        ...
        >
          <main className="px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mx-auto my-10 flex max-w-[550px] flex-col items-center justify-center space-y-4 rounded-xl bg-[#18181B] p-8 font-sans shadow-lg overflow-hidden">
              ...
              {/* bio  */}
              <p className="pb-2 text-start text-sm text-white/70">
