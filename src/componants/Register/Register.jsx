...
const Register = () => {
  ...
  return (
    <div className="md:h-[100vh] flex items-center justify-center bg-gradient-to-tr from-emerald-600 from-10% via-teal-600 via-30% to-cyan-600/90 to-80% backdrop-blur-3xl">
          ...
          >
            <div className="flex absolute items-center top-10 left-6 md:left-10">
              ...
              >
                ...
                <span className="relative text-black/80 font-bold">Log In</span>
              </Link>
            </div>
            <div className="flex h-[90%] md:w-[95%] lg:w-[85%] flex-col justify-center gap-3">
              ...
              {/* Photo url input */}
              <input
                className="text-white/80 bg-black/80 rounded-full px-6 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500/80 md:w-full mt-4"
                type="text"
